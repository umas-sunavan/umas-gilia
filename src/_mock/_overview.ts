...
export const employeeFeatured = (employee: Employee) => [
  {
    id: '0',
    title: '工讀生到職',
    description: `${employee.displayName}是AI工讀生，雖然笨笨的，但可以讓客戶留下來。`,
    coverUrl: _mock.image.cover(0),
  },
  {
    id: '1',
    title: '隨時查看對話紀錄',
    description: `頁面「工讀生的對話紀錄」可以看到${employee.displayName}接洽的顧客。`,
    coverUrl: _mock.image.cover(1),
  },
  {
    id: '2',
    title: 'AI工讀生不用勞健保',
    description: '有了AI工讀生，只需要訂閱費就好！勞健保都可以省下來了！',
    coverUrl: _mock.image.cover(2),
  },
  {
    id: '2',
    title: `${employee.displayName}的優勢是一定會進步`,
    description: '如果表現不好，您可以訓練他。AI工讀生受您指教是不會生氣的。',
    coverUrl: _mock.image.cover(3),
  },
  {
    id: '3',
    title: '訓練工讀生是老闆的職責',
    description: `頁面「工讀生訓練」中，您能新增多種奧客情境讓${employee.displayName}更得心應手。`,
    coverUrl: _mock.image.cover(4),
  },
  {
    id: '4',
    title: '隨時突襲工讀生狀況',
    description: `頁面「工讀生對話紀錄」中能檢查工作紀錄，適時接手與教育${employee.displayName}。`,
